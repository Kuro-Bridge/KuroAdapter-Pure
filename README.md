...
- status 快照语义边界：quit 计数偏大**已修**并经真机逐帧复验通过（2026-09-19，
  GAPS-2026-09-19 §2.1，`docs/history/SMOKE-2026-09-19-G1A.md`）；`query status` 返回最近
  一帧缓存、事件稀疏场景可滞后（对齐主仓的接受语义，GAPS-2026-09-19 §2.2）；
